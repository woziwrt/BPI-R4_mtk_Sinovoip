...
#cd mac80211_package; git checkout ea80aa938fc56a14b2fccecec41457aeee9e1647; cd -;	#MAC80211 v6.12 ok, ok 2	
#cd mac80211_package; git checkout 28bde50c1d5236ad890ef2fe3a0e89f731ee4421; cd -;	#MP 4.0 release
#cd mac80211_package; git checkout a9107e74a6eabf3763a81ce6dc04d54497de25eb; cd -;	#ucode
#cd mac80211_package; git checkout fe048b5e875dd09e54d4b2c43f4e6c98c6d1ffae; cd -;	mt76 2024-10-28
...
#cd mtk-openwrt-feeds; git checkout 5c7af0e6030cb6d32ea99b6970f5ec0768599ac8; cd -;
...
# My  modification of mtk default images building
...
export GIT_SSL_NO_VERIFY=1
sed -i 's/src-git mtk_openwrt_feed https:\/\/git01.mediatek.com\/openwrt\/feeds\/mtk-openwrt-feeds/src-git mtk_openwrt_feed https:\/\/git01.mediatek.com\/openwrt\/feeds\/mtk-openwrt-feeds^be63938/' feeds.conf.default
